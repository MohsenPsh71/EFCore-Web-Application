...
namespace EFCore_Web_Application.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Publisher_Id,Name,Location")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Publisher_Id,Name,Location")] Publisher publisher)
        {
