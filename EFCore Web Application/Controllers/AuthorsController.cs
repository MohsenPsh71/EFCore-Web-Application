...
namespace EFCore_Web_Application.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Author_Id,FirstName,LastName,BirthDate,Location")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Author_Id,FirstName,LastName,BirthDate,Location")] Author author)
        {
